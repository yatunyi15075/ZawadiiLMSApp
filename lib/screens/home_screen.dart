...
class _HomeScreenState extends State<HomeScreen> {
  bool _showWelcomeBanner = true; // This could be controlled by user preferences
            ...
            Padding(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    // TODO: Implement get unlimited functionality
                  },
            ...
            Expanded(
              child: Padding(
                ...
                child: ListView.builder(
                  itemCount: 3, // Replace with actual notes count
                  itemBuilder: (context, index) {
                    return Container(
                      ...
                      child: ListTile(
                        ...
                        title: Text(
                          index == 0 ? 'Mic Testing' : 'Sample Note ${index + 1}',
                          style: TextStyle(
                            fontWeight: FontWeight.w600,
